...
/* harmony default export */ const core_EventEmitter = ((/* unused pure expression or super */ null && (EventEmitter)));
;// ./src/js/core/Canvas.js
/**
...
class Canvas {
  ...
  bindEvents() {
    ...
    this.viewport.addEventListener('wheel', this._boundWheel, {
      passive: false
    });
  ...
  resize(width, height) {
    ...
    this.createCheckerboardPattern();
    this.render();
    this.app.events.emit(Events.DOCUMENT_RESIZE, {
      width,
      height
    });
  }
  ...
  setZoom(zoom, centerX = null, centerY = null) {
    ...
    this.render();
    this.app.events.emit(Events.CANVAS_ZOOM, {
      zoom: this.zoom
    });
  }
  ...
  pan(dx, dy) {
    ...
    this.panY += dy;
    this.render();
    this.app.events.emit(Events.CANVAS_PAN, {
      panX: this.panX,
      panY: this.panY
    });
  }
...
/* harmony default export */ const core_Canvas = ((/* unused pure expression or super */ null && (Canvas)));
...
/* harmony default export */ const core_History = ((/* unused pure expression or super */ null && (History)));
...
class Keyboard {
  ...
  normalizeShortcut(shortcut) {
    return shortcut.toLowerCase().split('+').sort((a, b) => {
...
/* harmony default export */ const core_Keyboard = ((/* unused pure expression or super */ null && (Keyboard)));
...
/* harmony default export */ const layers_Layer = ((/* unused pure expression or super */ null && (Layer)));
;// ./src/js/layers/LayerManager.js
/**
...
class LayerManager {
  ...
  addLayer(options = {}) {
    ...
    this.app.events.emit(Events.LAYER_ADD, {
      layer,
      index: insertIndex
    });
    return layer;
  ...
  removeLayer(layerId) {
    ...
    this.app.events.emit(Events.LAYER_REMOVE, {
      layer: removed,
      index
    });
  ...
  setActiveLayer(layerId) {
    ...
    if (layer) {
      this.activeLayer = layer;
      this.app.events.emit(Events.LAYER_SELECT, {
        layer
      });
    }
  }
  ...
  moveLayer(layerId, newIndex) {
    ...
    this.app.events.emit(Events.LAYER_REORDER, {
      layer,
  ...
  renameLayer(layerId, name) {
    ...
    if (layer) {
      layer.name = name;
      this.app.events.emit(Events.LAYER_RENAME, {
        layer,
        name
      });
    }
  ...
  setLayerVisibility(layerId, visible) {
    ...
    if (layer) {
      ...
      this.app.events.emit(Events.LAYER_VISIBILITY, {
        layer,
        visible
      });
      this.app.canvas.scheduleRender();
  ...
  setLayerOpacity(layerId, opacity) {
    ...
    if (layer) {
      ...
      this.app.events.emit(Events.LAYER_OPACITY, {
        layer,
        opacity: layer.opacity
      });
      this.app.canvas.scheduleRender();
  ...
  setLayerBlendMode(layerId, blendMode) {
    ...
    if (layer) {
      ...
      this.app.events.emit(Events.LAYER_BLEND_MODE, {
        layer,
        blendMode
      });
      this.app.canvas.scheduleRender();
  ...
  setLayerLocked(layerId, locked) {
    ...
    if (layer) {
      layer.locked = locked;
      this.app.events.emit(Events.LAYER_LOCK, {
        layer,
        locked
      });
    }
  ...
  duplicateLayer(layerId) {
    ...
    this.app.events.emit(Events.LAYER_DUPLICATE, {
      original: layer,
      duplicate: cloned
    });
    this.app.canvas.scheduleRender();
  ...
  mergeDown(layerId) {
    ...
    this.app.events.emit(Events.LAYER_MERGE, {
      merged: bottomLayer,
      removed: topLayer
    });
    this.app.canvas.scheduleRender();
...
/* harmony default export */ const layers_LayerManager = ((/* unused pure expression or super */ null && (LayerManager)));
;// ./src/js/tools/BaseTool.js
/**
...
/* harmony default export */ const tools_BaseTool = ((/* unused pure expression or super */ null && (BaseTool)));
;// ./src/js/tools/MoveTool.js
/**
...
/* harmony default export */ const tools_MoveTool = ((/* unused pure expression or super */ null && (MoveTool)));
;// ./src/js/tools/BrushTool.js
/**
...
class BrushTool extends BaseTool {
  ...
  drawStroke(ctx, points, pressure = 0.5) {
    ...
    const size = this.options.pressureSize ? this.options.size * pressure : this.options.size;
    const opacity = this.options.pressureOpacity ? this.options.opacity / 100 * pressure : this.options.opacity / 100;
  ...
  drawBrushDab(ctx, x, y, size, color) {
    ...
    if (this.options.hardness < 100) {
      ctx.save();
      ctx.globalCompositeOperation = 'source-over';
      const cacheInvalid = !this._colorBrushCanvas || this._cachedColor !== color || this._cachedHardness !== this.options.hardness || this._cachedSize !== this.options.size;
      if (cacheInvalid) {
...
/* harmony default export */ const tools_BrushTool = ((/* unused pure expression or super */ null && (BrushTool)));
...
class EraserTool extends BaseTool {
  ...
  eraseAt(ctx, point) {
    ...
    if (this.options.mode === 'block') {
      ...
      if (this.options.hardness < 100) {
        // Soft eraser
        const gradient = ctx.createRadialGradient(point.x, point.y, 0, point.x, point.y, halfSize);
        const hardness = this.options.hardness / 100;
        gradient.addColorStop(0, 'rgba(0, 0, 0, 1)');
...
/* harmony default export */ const tools_EraserTool = ((/* unused pure expression or super */ null && (EraserTool)));
...
class ShapeTool extends BaseTool {
    ...
    if (this.options.shape === 'line') {
      return {
        points: [{
          ...
          x: constrain ? this.constrainLine(start, end).x : end.x,
          y: constrain ? this.constrainLine(start, end).y : end.y
        }]
      };
    }
    return {
  ...
  renderOverlay(ctx) {
    ...
    ctx.save();
    ctx.fillStyle = this.options.filled ? this.options.fillColor : 'transparent';
    const previewStroke = this.options.stroked || this.options.shape === 'line' ? this._effectiveStrokeColor() : '#0066ff';
...
/* harmony default export */ const tools_ShapeTool = ((/* unused pure expression or super */ null && (ShapeTool)));
  ...
  getTextBounds(layer) {
    ...
    if (!ctx) {
      return {
        ...
        y: layer.position.y,
        width: 100,
        height: layer.textStyle.fontSize
      };
    }
...
/* harmony default export */ const tools_TextTool = ((/* unused pure expression or super */ null && (TextTool)));
;// ./src/js/tools/CropTool.js
/**
...
class CropTool extends BaseTool {
  ...
  applyCrop() {
    ...
    this.app.layers.getLayers().forEach(layer => {
      ...
      tempCtx.drawImage(layer.canvas, x - layer.position.x, y - layer.position.y, width, height, 0, 0, width, height);
...
/* harmony default export */ const tools_CropTool = ((/* unused pure expression or super */ null && (CropTool)));
...
/* harmony default export */ const tools_HandTool = ((/* unused pure expression or super */ null && (HandTool)));
;// ./src/js/tools/EyedropperTool.js
/**
...
/* harmony default export */ const tools_EyedropperTool = ((/* unused pure expression or super */ null && (EyedropperTool)));
;// ./src/js/tools/GradientTool.js
/**
...
/* harmony default export */ const tools_GradientTool = ((/* unused pure expression or super */ null && (GradientTool)));
;// ./src/js/tools/FillTool.js
/**
  ...
  floodFill(layer, startX, startY, fillColor) {
    ...
    if (this.options.contiguous) {
      ...
      while (stack.length > 0) {
        ...
        if (!this.colorsMatch(targetR, targetG, targetB, targetA, data[pixelIdx], data[pixelIdx + 1], data[pixelIdx + 2], data[pixelIdx + 3], tolerance)) {
          continue;
        }
        visited[idx] = 1;
      ...
      for (let i = 0; i < data.length; i += 4) {
        if (this.colorsMatch(targetR, targetG, targetB, targetA, data[i], data[i + 1], data[i + 2], data[i + 3], tolerance)) {
          data[i] = fillRGB.r;
          data[i + 1] = fillRGB.g;
          data[i + 2] = fillRGB.b;
          data[i + 3] = fillA;
...
/* harmony default export */ const tools_FillTool = ((/* unused pure expression or super */ null && (FillTool)));
;// ./src/js/tools/MarqueeTool.js
/**
...
/* harmony default export */ const tools_MarqueeTool = ((/* unused pure expression or super */ null && (MarqueeTool)));
;// ./src/js/tools/ToolManager.js
/**
...
class ToolManager {
  ...
  setTool(name) {
    ...
    this.app.events.emit(Events.TOOL_SELECT, {
      tool: name
    });
  }
...
/* harmony default export */ const tools_ToolManager = ((/* unused pure expression or super */ null && (ToolManager)));
;// ./src/js/selection/Selection.js
/**
...
class Selection {
  ...
  setRect(x, y, width, height, shape = 'rectangle') {
    ...
    this.app.events.emit(Events.SELECTION_CREATE, {
      bounds: this.bounds,
      shape
    });
  }
  ...
  _buildInvertMask() {
    ...
    if (this.shape === 'ellipse' && this.bounds) {
      ctx.beginPath();
      ctx.ellipse(this.bounds.x + this.bounds.width / 2, this.bounds.y + this.bounds.height / 2, this.bounds.width / 2, this.bounds.height / 2, 0, 0, Math.PI * 2);
      ctx.fill();
    } else if (this.path) {
      ctx.beginPath();
...
/* harmony default export */ const selection_Selection = ((/* unused pure expression or super */ null && (Selection)));
;// ./src/js/filters/FilterManager.js
/**
...
class FilterManager {
  ...
  applyFilter(filterName, options = {}) {
    ...
    const imageData = this.originalImageData ? new ImageData(new Uint8ClampedArray(this.originalImageData.data), this.originalImageData.width, this.originalImageData.height) : layer.ctx.getImageData(0, 0, layer.width, layer.height);
    ...
    this.app.canvas.scheduleRender();
    this.app.events.emit(Events.FILTER_APPLY, {
      filter: filterName,
      options
    });
  }
  previewFilter(filterName, options = {}) {
    ...
    const filtered = this.processFilter(filterName, new ImageData(new Uint8ClampedArray(this.originalImageData.data), this.originalImageData.width, this.originalImageData.height), options);
    layer.ctx.putImageData(filtered, 0, 0);
    this.app.canvas.scheduleRender();
    this.app.events.emit(Events.FILTER_PREVIEW, {
      filter: filterName,
      options
    });
  }
  processFilter(filterName, imageData, options) {
    switch (filterName) {
      case 'brightness':
        return this.adjustBrightness(imageData, options.value || 0);
      case 'contrast':
        return this.adjustContrast(imageData, options.value || 0);
      case 'saturation':
        return this.adjustSaturation(imageData, options.value || 0);
      case 'adjust':
        return this.applyAdjust(imageData, options);
      case 'grayscale':
        return this.grayscale(imageData, options.value !== undefined ? options.value : 100);
      case 'sepia':
        return this.sepia(imageData, options.value !== undefined ? options.value : 100);
      case 'invert':
        return this.invert(imageData, options.value !== undefined ? options.value : 100);
      case 'blur':
        return this.blur(imageData, options.radius || 5);
      case 'sharpen':
        return this.sharpen(imageData, options.amount || 1);
      case 'hueRotate':
        return this.hueRotate(imageData, options.angle || 0);
      default:
        return imageData;
    }
  }
...
/* harmony default export */ const filters_FilterManager = ((/* unused pure expression or super */ null && (FilterManager)));
;// ./src/js/ui/ColorManager.js
/**
...
class ColorManager {
  constructor(app) {
    ...
    this.swatches = ['#000000', '#ffffff', '#ff0000', '#00ff00', '#0000ff', '#ffff00', '#00ffff', '#ff00ff', '#ff8800', '#8800ff', '#888888', '#444444', '#cccccc', '#880000', '#008800'];
  }
  setForeground(color) {
    this.foreground = color;
    this.app.events.emit(Events.COLOR_FOREGROUND, {
      color
    });
  }
  setBackground(color) {
    this.background = color;
    this.app.events.emit(Events.COLOR_BACKGROUND, {
      color
    });
  }
  swap() {
...
/* harmony default export */ const ui_ColorManager = ((/* unused pure expression or super */ null && (ColorManager)));
// EXTERNAL MODULE: ./node_modules/@bookklik/senangstart-icons/dist/senangstart-icon.min.js
var senangstart_icon_min = __webpack_require__(720);
;// ./src/js/ui/Toast.js
/**
...
/* harmony default export */ const ui_Toast = ((/* unused pure expression or super */ null && (Toast)));
;// ./src/js/ui/Dialog.js
/**
...
/* harmony default export */ const ui_Dialog = ((/* unused pure expression or super */ null && (Dialog)));
;// ./src/js/ui/OptionsSheet.js
/**
...
/* harmony default export */ const ui_OptionsSheet = ((/* unused pure expression or super */ null && (OptionsSheet)));
;// ./src/js/ui/UI.js
/**
...
class UI {
  ...
  bindFilterSubmenuEvents(submenu) {
    ...
    const getLastPreview = () => selectedFilter !== 'none' ? {
  ...
  _convertIntensity(filterName, intensity) {
    switch (filterName) {
      ...
      case 'contrast':
        ...
        return {
          value: Math.round((intensity - 50) * 2.56)
        };
      case 'saturation':
        // Convert 0-100 to -100 to 100 range (50 = 0 change)
        return {
          value: (intensity - 50) * 2
        };
      case 'blur':
        // Convert 0-100 to 1-10 radius
        return {
          radius: Math.max(1, Math.round(intensity / 10))
        };
      case 'sharpen':
...
/* harmony default export */ const ui_UI = ((/* unused pure expression or super */ null && (UI)));
;// ./src/js/io/FileManager.js
/**
...
class FileManager {
  ...
  newDocument(options = {}) {
    ...
    this.hasUnsavedChanges = false;
    this.app.canvas.fitToScreen();
    this.app.events.emit(Events.DOCUMENT_NEW, {
      width,
      height
    });
  }
  ...
  async openImage(file) {
    ...
    return new Promise((resolve, reject) => {
      img.onload = () => {
        ...
        this.app.events.emit(Events.DOCUMENT_OPEN, {
  ...
  async openProject(file) {
    ...
    if (!project || typeof project.width !== 'number' || typeof project.height !== 'number' || project.width <= 0 || project.height <= 0) {
  ...
  async save() {
    ...
    this.hasUnsavedChanges = false;
    this.app.events.emit(Events.DOCUMENT_SAVE, {
      name: this.projectName
    });
  }
  setProjectName(name) {
  ...
  async export(format = 'png', quality = 1, name = null) {
    ...
    link.href = dataURL;
    link.click();
    this.app.events.emit(Events.DOCUMENT_EXPORT, {
      format,
      name: filename
    });
  }
...
/* harmony default export */ const io_FileManager = ((/* unused pure expression or super */ null && (FileManager)));
;// ./src/js/io/Clipboard.js
/**
...
/* harmony default export */ const io_Clipboard = ((/* unused pure expression or super */ null && (Clipboard)));
;// ./src/js/swp.js
/**
...
class SWP {
  ...
  applyTheme(theme) {
    ...
    const app = this.container.classList.contains('swp-app') ? this.container : this.container.querySelector('.swp-app');
    if (app) {
  ...
  for (const key in dataset) {
    if (key.startsWith('swp') && key !== 'swp') {
      ...
      if (!(optionKey in options)) {
        ...
        if (value === 'true') value = true;else if (value === 'false') value = false;else if (!isNaN(value) && value !== '') value = parseFloat(value);
...
/* harmony default export */ const swp = (SWP);
